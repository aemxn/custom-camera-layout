...
public class Camera2BasicFragment extends Fragment
    ...
    public void onResume() {
        ...
        if (mTextureView.isAvailable()) {
            Log.i(TAG, "onResume texture available");
            openCamera(mTextureView.getWidth(), mTextureView.getHeight());
        } else {
            Log.i(TAG, "onResume texture not available");
    ...
    private void setUpCameraOutputs(int width, int height) {
        ...
        try {
            for (String cameraId : manager.getCameraIdList()) {
                ...
                Log.i(TAG, "largest height: " + largest.getHeight());
                Log.i(TAG, "largest width: " + largest.getWidth());
                Log.i(TAG, "smallest height: " + Collections.min(Arrays.asList(map.getOutputSizes(ImageFormat.JPEG)), new CompareSizesByArea()).getHeight());
                Log.i(TAG, "smallest width: " + Collections.min(Arrays.asList(map.getOutputSizes(ImageFormat.JPEG)), new CompareSizesByArea()).getWidth());
